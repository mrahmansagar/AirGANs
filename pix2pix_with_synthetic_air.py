# -*- coding: utf-8 -*-
"""
Created on Thu Aug 31 16:07:58 2023
...
src_img_dir = os.path.join(data_dir, 'with_air\\train')
...
models.train_pix2pix(gene, disc, p2p_model, src_img, tar_img, epochs=30, summary_interval=1, name='models/src2tar_with_synthetic_air')

# loading the model which is trained for 30 epochs
from keras.models import load_model
model = load_model('models/src2tar_with_synthetic_air_after_165000.h5')
