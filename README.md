...
<div style="display: flex; justify-content: center;">
  <div style="flex: 1; text-align: center;">
    <figure style="display: inline-block;">
      <img src="images/slices_wo_airbubble.png" alt="slices_wo_airbubble" style="width: 400px;">
      <figcaption>slices without airbubble</figcaption>
    </figure>
  </div>
  <div style="flex: 1; text-align: center;">
    <figure style="display: inline-block;">
      <img src="images/slices_w_airbubble.png" alt="slices_w_airbubble" style="width: 400px;">
...
<div style="display: flex; justify-content: center;">
  <div style="flex: 1; text-align: center;">
    <figure style="display: inline-block;">
      <img src="images/slices_w_real_airbubble.png" alt="slices_w_real_airbubble" style="width: 400px;">
      <figcaption>slices with real airbubble</figcaption>
    </figure>
  </div>
  <div style="flex: 1; text-align: center;">
    <figure style="display: inline-block;">
      <img src="images/slices_w_real_airbubble_copied.png" alt="slices_w_real_airbubble_copied" style="width: 400px;">
